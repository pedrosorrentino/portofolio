            ...
            >
              {menuTab.map((i) => (
                <button
                  key={i.id}
                  class={{
                    'truncate font-mono text-xs sm:text-base flex gap-2 flex-1 justify-center items-center py-2  cursor-pointer hover:bg-slate-300 dark:hover:bg-slate-900 dark:hover:text-indigo-400 text-slate-700 dark:text-indigo-400 transition-colors hover:border-t hover:border-slate-700 dark:hover:border-indigo-400':
                      true,
...
export const head: DocumentHead = {
  title: 'Pedro Sorrentino | Building the Future with JavaScript',
  meta: [
    {
      name: 'description',
      content:
