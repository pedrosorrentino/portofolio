    ...
    <>
      ...
      {tag === "h2" && (
        <h2
          class={`${
            center && "text-center"
          } mb-2 bg-gradient-to-r from-slate-500 via-blue-500 to-purple-600 dark:from-green-400 dark:via-blue-500 dark:to-purple-600 bg-clip-text  text-transparent text-xl sm:text-2xl`}
        >
          {name}
        </h2>
      )}
